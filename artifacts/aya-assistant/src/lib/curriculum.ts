...
export const lowerSecondarySubjects: Subject[] = [
  {
    ...
    borderClass: "border-orange-200",
    topics: [
      { id: "natural-numbers",     label: { bg: "Натурални числа",      en: "Natural Numbers",    es: "Números naturales",   de: "Natürliche Zahlen",  fr: "Nombres naturels" } },
      { id: "divisibility",        label: { bg: "Делимост",              en: "Divisibility",       es: "Divisibilidad",       de: "Teilbarkeit",        fr: "Divisibilité" } },
      { id: "common-fractions",    label: { bg: "Обикновени дроби",      en: "Common Fractions",   es: "Fracciones comunes",  de: "Gemeine Brüche",     fr: "Fractions ordinaires" } },
      { id: "decimal-fractions",   label: { bg: "Десетични дроби",       en: "Decimal Fractions",  es: "Fracciones decimales",de: "Dezimalbrüche",      fr: "Fractions décimales" } },
      { id: "geometric-figures",   label: { bg: "Геометрични фигури",    en: "Geometric Figures",  es: "Figuras geométricas", de: "Geometrische Figuren",fr: "Figures géométriques" } },
      { id: "perimeter-area",      label: { bg: "Периметър и лице",      en: "Perimeter & Area",   es: "Perímetro y área",    de: "Umfang und Fläche",  fr: "Périmètre et aire" } },
      { id: "percentage-5grade",   label: { bg: "Проценти",              en: "Percentages",        es: "Porcentajes",         de: "Prozentsätze",       fr: "Pourcentages" } },
      { id: "word-problems-5grade",label: { bg: "Текстови задачи",       en: "Word Problems",      es: "Problemas textuales", de: "Textaufgaben",       fr: "Problèmes" } },
    ],
  },
  {
