...
export const listMissionsResponseAiGeneratedDefault = false;
...
export const ListMissionsResponseItem = zod.object({
  ...
  topicId: zod
    .string()
    .nullish()
    .describe("Curriculum topic ID (links to frontend curriculum.ts Topic.id)"),
  subjectId: zod
    .string()
    .nullish()
    .describe(
  ...
  aiGenerated: zod
    .boolean()
    .default(listMissionsResponseAiGeneratedDefault)
    .describe(
...
export const generateMissionsResponseMissionsItemAiGeneratedDefault = false;
...
export const GenerateMissionsResponse = zod.object({
  ...
  missions: zod.array(
    zod.object({
      ...
      aiGenerated: zod
        .boolean()
        .default(generateMissionsResponseMissionsItemAiGeneratedDefault)
        .describe(
          "Whether this mission was generated by AI (vs. hardcoded curriculum)",
        ),
    }),
 ...
 */
export const AutoExpandMissionsBody = zod.object({
  childId: zod.number().describe("ID of the child"),
  zone: zod
    .string()
    .describe('Zone name to auto-expand (e.g. \"Math Island\")'),
  pendingThreshold: zod
    .number()
    .optional()
    .describe(
...
export const AutoExpandMissionsResponse = zod.object({
  triggered: zod
    .boolean()
    .describe("Whether auto-generation was triggered in the background"),
  reason: zod
    .string()
    .optional()
    .describe("Human-readable reason when triggered=false"),
  pendingCount: zod
    .number()
    .optional()
    .describe(
  ...
  threshold: zod
    .number()
    .optional()
    .describe("The threshold used for the check"),
});
