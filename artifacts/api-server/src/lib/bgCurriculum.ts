...
export const BG_CURRICULUM: GradeSubjectEntry[] = [
  ...
  // ── Mathematics Grade 5 (Natural numbers, Fractions, Basic Geometry) ────────
  {
    grade: 5,
    ...
    topics: [
      {
        ...
        topicTitleBg: "Операции с натурални числа",
        topicTitleEn: "Natural number operations",
        difficultyLevel: "intermediate",
        lessonType: "lesson",
        skills: ["addition_subtraction", "multiplication_division", "order_of_operations"],
      },
      {
        topicId: "divisibility",
        topicTitleBg: "Делимост на натуралните числа",
        topicTitleEn: "Divisibility rules",
        difficultyLevel: "intermediate",
        lessonType: "lesson",
        skills: ["divisors", "multiples", "divisibility_rules", "gcd"],
      },
      {
        topicId: "common-fractions",
        topicTitleBg: "Обикновени дроби",
        topicTitleEn: "Common fractions",
        difficultyLevel: "intermediate",
        lessonType: "practice",
        skills: ["fraction_parts", "compare_fractions", "add_subtract_fractions"],
      },
      {
        topicId: "decimal-fractions",
        topicTitleBg: "Десетични дроби",
        topicTitleEn: "Decimal fractions",
        difficultyLevel: "intermediate",
        lessonType: "practice",
        skills: ["decimal_notation", "compare_decimals", "add_subtract_decimals"],
      },
      {
        topicId: "measurement-units",
        topicTitleBg: "Мерни единици",
        topicTitleEn: "Measurement units",
        difficultyLevel: "intermediate",
        lessonType: "lesson",
        skills: ["length_units", "weight_units", "volume_units", "unit_conversion"],
      },
      {
        topicId: "perimeter-area",
        topicTitleBg: "Периметър и лице",
        topicTitleEn: "Perimeter and area",
        difficultyLevel: "intermediate",
        lessonType: "practice",
        skills: ["rectangle_perimeter", "triangle_area", "circle_basics"],
      },
      {
        topicId: "basic-geometry",
        topicTitleBg: "Основни геометрични фигури",
        topicTitleEn: "Basic geometric shapes",
        difficultyLevel: "intermediate",
        lessonType: "lesson",
        skills: ["triangles", "quadrilaterals", "angles", "polygons"],
      },
      {
        topicId: "word-problems-5grade",
        topicTitleBg: "Текстови задачи",
        topicTitleEn: "Word problems",
        difficultyLevel: "intermediate",
        lessonType: "reading",
        skills: ["problem_solving", "choose_operation", "verify_solution"],
      },
    ],
  },

  // ── Bulgarian Language Grade 5 (Advanced) ────────────────────────────────────
  {
    grade: 5,
    ...
    topics: [
      {
        topicId: "morphology",
        topicTitleBg: "Морфология",
        topicTitleEn: "Morphology",
        difficultyLevel: "intermediate",
        lessonType: "lesson",
        skills: ["word_structure", "affixes", "morpheme_analysis"],
      },
      {
        topicId: "syntax",
        topicTitleBg: "Синтаксис",
        topicTitleEn: "Syntax",
        difficultyLevel: "intermediate",
        lessonType: "lesson",
        skills: ["sentence_structure", "clauses", "dependent_clauses"],
      },
      {
        topicId: "stylistics",
        topicTitleBg: "Стилистика",
        topicTitleEn: "Stylistics",
        difficultyLevel: "intermediate",
        lessonType: "lesson",
        skills: ["text_types", "register", "rhetorical_devices"],
      },
      {
        topicId: "essay-writing",
        topicTitleBg: "Съчинение",
        topicTitleEn: "Essay writing",
        difficultyLevel: "intermediate",
        lessonType: "writing",
        skills: ["thesis_statement", "paragraph_structure", "argumentation"],
      },
      {
        topicId: "punctuation-adv",
        topicTitleBg: "Пунктуация",
        topicTitleEn: "Punctuation",
        difficultyLevel: "intermediate",
        lessonType: "practice",
        skills: ["comma_rules", "semicolon", "dash_usage", "quotation_marks"],
      },
      {
        topicId: "word-forms",
        topicTitleBg: "Словообразуване",
        topicTitleEn: "Word formation",
        difficultyLevel: "intermediate",
        lessonType: "lesson",
        skills: ["derivation", "composition", "abbreviation"],
      },
    ],
  },

  // ── Mathematics Grade 6 (Ratios, Percentages, Equations, Geometry) ─────────
  {
    grade: 6,
    subjectId: "mathematics-advanced",
    topics: [
      {
        ...
        topicTitleBg: "Съотношения и пропорции",
        topicTitleEn: "Ratios and proportions",
        difficultyLevel: "advanced",
        lessonType: "lesson",
        skills: ["ratio_concept", "proportion_solving", "scale_factor"],
      },
      {
        topicId: "percentage-6grade",
        topicTitleBg: "Проценти",
        topicTitleEn: "Percentages",
        difficultyLevel: "advanced",
        lessonType: "lesson",
        skills: ["percentage_concept", "find_percentage", "percent_change"],
      },
      {
        topicId: "integers-rational",
        topicTitleBg: "Цели и рационални числа",
        topicTitleEn: "Integers and rational numbers",
        difficultyLevel: "advanced",
        lessonType: "lesson",
        skills: ["negative_numbers", "absolute_value", "rational_operations"],
      },
      {
        topicId: "coordinate-plane",
        topicTitleBg: "Координатна система",
        topicTitleEn: "Coordinate plane",
        difficultyLevel: "advanced",
        lessonType: "practice",
        skills: ["plot_points", "quadrants", "distance_formula"],
      },
      {
        topicId: "algebraic-expressions",
        topicTitleBg: "Алгебрични изрази",
        topicTitleEn: "Algebraic expressions",
        difficultyLevel: "advanced",
        lessonType: "lesson",
        skills: ["variables", "simplify_expressions", "combine_like_terms"],
      },
      {
        topicId: "geometry-angles",
        topicTitleBg: "Ъгли и многоъгълници",
        topicTitleEn: "Angles and polygons",
        difficultyLevel: "advanced",
        lessonType: "lesson",
        skills: ["angle_types", "polygon_properties", "angle_sum"],
      },
      {
        topicId: "circle-geometry",
        topicTitleBg: "Окръжност и кръг",
        topicTitleEn: "Circle and disk",
        difficultyLevel: "advanced",
        lessonType: "practice",
        skills: ["circle_elements", "circumference", "circle_area"],
      },
    ],
  },

  // ── Bulgarian Language Grade 6 (Advanced) ────────────────────────────────────
  {
    grade: 6,
    subjectId: "bulgarian-language-adv",
    topics: [
      ...
      },
      {
        ...
        difficultyLevel: "advanced",
        lessonType: "lesson",
        skills: ["sentence_structure", "clauses", "compound_sentences"],
      },
      {
        topicId: "stylistics",
        topicTitleBg: "Стилистика",
        ...
        difficultyLevel: "advanced",
        lessonType: "lesson",
        skills: ["text_types", "register", "literary_devices"],
      },
      {
        topicId: "essay-writing",
        topicTitleBg: "Съчинение",
        ...
        difficultyLevel: "advanced",
        lessonType: "writing",
        skills: ["thesis_statement", "evidence_support", "conclusion"],
      },
      {
        topicId: "punctuation-adv",
        topicTitleBg: "Пунктуация",
        ...
        difficultyLevel: "advanced",
        lessonType: "practice",
        skills: ["ellipsis", "parentheses", "complex_punctuation"],
      },
      {
        topicId: "word-forms",
        topicTitleBg: "Словообразуване",
        ...
        difficultyLevel: "advanced",
        lessonType: "lesson",
        skills: ["derivation", "composition", "word_families"],
      },
    ],
  },

  // ── Mathematics Grade 7 (Equations, Inequalities, Functions, Probability) ──
  {
    grade: 7,
    subjectId: "mathematics-advanced",
    topics: [
      {
        ...
        topicTitleBg: "Линейни уравнения",
        topicTitleEn: "Linear equations",
        difficultyLevel: "advanced",
        lessonType: "lesson",
        skills: ["equation_solving", "variables_both_sides", "application_problems"],
      },
      {
        topicId: "inequalities",
        topicTitleBg: "Линейни неравенства",
        topicTitleEn: "Linear inequalities",
        difficultyLevel: "advanced",
        lessonType: "lesson",
        skills: ["inequality_solving", "compound_inequalities", "graphing_inequalities"],
      },
      {
        topicId: "functions-relations",
        topicTitleBg: "Функции и релации",
        topicTitleEn: "Functions and relations",
        difficultyLevel: "advanced",
        lessonType: "lesson",
        skills: ["function_notation", "domain_range", "function_composition"],
      },
      {
        topicId: "systems-equations",
        topicTitleBg: "Системи уравнения",
        topicTitleEn: "Systems of equations",
        difficultyLevel: "advanced",
        lessonType: "practice",
        skills: ["substitution_method", "elimination_method", "graphical_solutions"],
      },
      {
        topicId: "probability-basics",
        topicTitleBg: "Вероятност",
        topicTitleEn: "Probability basics",
        difficultyLevel: "advanced",
        lessonType: "lesson",
        skills: ["sample_space", "probability_definition", "independent_events"],
      },
      {
        topicId: "advanced-geometry",
        topicTitleBg: "Напредна геометрия",
        topicTitleEn: "Advanced geometry",
        difficultyLevel: "advanced",
        lessonType: "lesson",
        skills: ["trigonometry_basics", "similar_triangles", "pythagorean_theorem"],
      },
      {
        topicId: "statistics-data",
        topicTitleBg: "Статистика и данни",
        topicTitleEn: "Statistics and data",
        difficultyLevel: "advanced",
        lessonType: "practice",
        skills: ["mean_median_mode", "standard_deviation", "data_interpretation"],
      },
    ],
  },

  // ── Bulgarian Language Grade 7 (Advanced) ────────────────────────────────────
  {
    grade: 7,
    subjectId: "bulgarian-language-adv",
    topics: [
      {
        ...
        difficultyLevel: "advanced",
        lessonType: "lesson",
        skills: ["word_structure", "inflection", "syntax_morphology"],
      },
      {
        topicId: "syntax",
        topicTitleBg: "Синтаксис",
        ...
        difficultyLevel: "advanced",
        lessonType: "lesson",
        skills: ["complex_sentences", "subordination", "clause_analysis"],
      },
      {
        topicId: "stylistics",
        topicTitleBg: "Стилистика",
        ...
        difficultyLevel: "advanced",
        lessonType: "lesson",
        skills: ["register_analysis", "discourse", "text_cohesion"],
      },
      {
        topicId: "essay-writing",
        topicTitleBg: "Съчинение",
        ...
        difficultyLevel: "advanced",
        lessonType: "writing",
        skills: ["literary_analysis", "argumentation", "critical_thinking"],
      },
      {
        topicId: "punctuation-adv",
        topicTitleBg: "Пунктуация",
        ...
        difficultyLevel: "advanced",
        lessonType: "practice",
        skills: ["advanced_punctuation", "stylistic_punctuation"],
      },
      {
        topicId: "word-forms",
        topicTitleBg: "Словообразуване",
        ...
        difficultyLevel: "advanced",
        lessonType: "lesson",
        skills: ["productive_affixes", "lexical_variation", "etymology"],
      },
    ],
  },
];
