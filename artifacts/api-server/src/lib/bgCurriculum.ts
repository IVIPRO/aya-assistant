    ...
    topics: [
      {
        ...
        topicTitleBg: "Натурални числа",
        topicTitleEn: "Natural numbers",
        difficultyLevel: "intermediate",
        lessonType: "lesson",
        skills: ["large_numbers", "place_value_extended", "rounding"],
      },
      {
        topicId: "divisibility",
        topicTitleBg: "Делимост",
        topicTitleEn: "Divisibility",
        difficultyLevel: "intermediate",
        lessonType: "lesson",
        skills: ["divisors", "multiples", "prime_numbers", "divisibility_rules"],
      },
      {
        ...
        difficultyLevel: "intermediate",
        lessonType: "practice",
        skills: ["fraction_parts", "compare_fractions", "add_fractions", "subtract_fractions"],
      },
      {
        ...
        difficultyLevel: "intermediate",
        lessonType: "practice",
        skills: ["decimal_notation", "compare_decimals", "round_decimals", "add_subtract_decimals"],
      },
      {
        topicId: "geometric-figures",
        topicTitleBg: "Геометрични фигури",
        topicTitleEn: "Geometric figures",
        difficultyLevel: "intermediate",
        lessonType: "lesson",
        skills: ["polygons", "angles", "parallel_lines", "congruence"],
      },
      {
        topicId: "perimeter-area",
        topicTitleBg: "Периметър и лице",
        topicTitleEn: "Perimeter & Area",
        difficultyLevel: "intermediate",
        lessonType: "practice",
        skills: ["rectangle_perimeter", "triangle_perimeter", "rectangle_area", "triangle_area"],
      },
      {
        topicId: "percentage-5grade",
        topicTitleBg: "Проценти",
        topicTitleEn: "Percentages",
        difficultyLevel: "intermediate",
        lessonType: "lesson",
        skills: ["percent_concept", "find_percentage", "discount_markup"],
      },
      {
        ...
        difficultyLevel: "intermediate",
        lessonType: "reading",
        skills: ["multi_step_problems", "choose_operation", "interpret_data"],
      },
    ],
  },
  ...
  // ── Mathematics Grade 6 (Advanced) ──────────────────────────────────────────
  {
    ...
    topics: [
      ...
      },
      {
        ...
        difficultyLevel: "advanced",
        lessonType: "practice",
        skills: ["fraction_parts", "compare_fractions", "multiply_divide_fractions"],
      },
      {
        topicId: "decimal-fractions",
        topicTitleBg: "Десетични дроби",
        ...
        difficultyLevel: "advanced",
        lessonType: "practice",
        skills: ["decimal_notation", "multiply_decimals", "divide_decimals"],
      },
      {
        topicId: "geometric-figures",
        topicTitleBg: "Геометрични фигури",
        ...
        difficultyLevel: "advanced",
        lessonType: "lesson",
        skills: ["polygons", "circle_properties", "symmetry", "transformations"],
      },
      {
        topicId: "perimeter-area",
        topicTitleBg: "Периметър и лице",
        ...
        difficultyLevel: "advanced",
        lessonType: "practice",
        skills: ["complex_shapes", "circle_area", "composite_figures"],
      },
      {
        topicId: "percentage-5grade",
        topicTitleBg: "Проценти",
        ...
        difficultyLevel: "advanced",
        lessonType: "lesson",
        skills: ["percent_concept", "interest", "ratios_percentages"],
      },
      {
        topicId: "word-problems-5grade",
        topicTitleBg: "Текстови задачи",
        ...
        difficultyLevel: "advanced",
        lessonType: "reading",
        skills: ["multi_step_problems", "rate_problems", "proportion"],
      },
    ],
  },
    ...
    topics: [
      {
        ...
        difficultyLevel: "advanced",
        lessonType: "lesson",
        skills: ["large_numbers", "scientific_notation", "rounding"],
      },
      {
        topicId: "divisibility",
        topicTitleBg: "Делимост",
        ...
        difficultyLevel: "advanced",
        lessonType: "lesson",
        skills: ["gcd_lcm", "prime_factorization", "number_theory"],
      },
      {
        topicId: "common-fractions",
        topicTitleBg: "Обикновени дроби",
        ...
        difficultyLevel: "advanced",
        lessonType: "practice",
        skills: ["complex_fractions", "mixed_operations", "fraction_equations"],
      },
      {
        topicId: "decimal-fractions",
        topicTitleBg: "Десетични дроби",
        ...
        difficultyLevel: "advanced",
        lessonType: "practice",
        skills: ["repeating_decimals", "fraction_decimal_conversion"],
      },
      {
        topicId: "geometric-figures",
        topicTitleBg: "Геометрични фигури",
        ...
        difficultyLevel: "advanced",
        lessonType: "lesson",
        skills: ["coordinate_geometry", "3d_figures", "spatial_relationships"],
      },
      {
        topicId: "perimeter-area",
        topicTitleBg: "Периметър и лице",
        ...
        difficultyLevel: "advanced",
        lessonType: "practice",
        skills: ["volume", "surface_area", "pythagorean_theorem"],
      },
      {
        topicId: "percentage-5grade",
        topicTitleBg: "Проценти",
        ...
        difficultyLevel: "advanced",
        lessonType: "lesson",
        skills: ["compound_interest", "percent_change", "financial_math"],
      },
      {
        topicId: "word-problems-5grade",
        topicTitleBg: "Текстови задачи",
        ...
        difficultyLevel: "advanced",
        lessonType: "reading",
        skills: ["optimization", "systems_problems", "real_world_modeling"],
      },
    ],
  },
