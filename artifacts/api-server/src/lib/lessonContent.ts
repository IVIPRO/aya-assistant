    ...
    "mathematics-advanced/decimal-fractions": {
      bg: {
        low: {
          ...
          examples: [
            { problem: "Какво е десетичното представяне на 1/2?", solution: "0.5", hint: "1÷2 = 0.5" },
            { problem: "Какво е десетичното представяне на 1/4?", solution: "0.25", hint: "1÷4 = 0.25" },
            { problem: "Напиши десетичната дроб за три лева и 50 стотинки.", solution: "3.50 или 3.5", hint: "3 лева (цяло число) и 50 стотинки (0.50) = 3.50" },
          ],
        ...
        high: {
          ...
          examples: [
            { problem: "Събери: 2.5 + 1.3", solution: "3.8", hint: "2.5 + 1.3: подравни точките, събери: 2+1=3, 5+3=8. Резултат: 3.8" },
            { problem: "Умножи: 0.5 × 4", solution: "2.0 или 2", hint: "0.5 × 4 = 2. Или: половина от 4 е 2." },
            { problem: "Раздели: 3 ÷ 0.5", solution: "6", hint: "3 ÷ 0.5 = 3 ÷ (1/2) = 3 × 2 = 6" },
          ],
